  ...
  return(
    <div style={{fontFamily:"'DM Sans',system-ui,sans-serif",background:"linear-gradient(135deg,#17365d,#0c2141)",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"28px 24px"}}>
      ...
      <div style={{width:"100%",maxWidth:760,background:"#fff",borderRadius:34,padding:"42px 58px 54px",boxShadow:"0 28px 72px rgba(0,0,0,.28)",textAlign:"center",overflow:"visible"}}>
        ...
        <div style={{fontFamily:"'Syne',sans-serif",fontSize:28,fontWeight:800,lineHeight:1.18,paddingBottom:8,marginBottom:24,overflow:"visible",display:"flex",justifyContent:"center",alignItems:"flex-end",gap:0,whiteSpace:"nowrap"}}>
          <span style={{color:"#162949"}}>Estrategia</span><span style={{color:"#e45843"}}>Trade</span>
        </div>
        <div style={{display:"inline-flex",alignItems:"center",justifyContent:"center",background:"#f4f5f7",padding:"20px 28px",borderRadius:2,marginTop:4,marginBottom:22,minWidth:"min(100%, 520px)"}}>
          <div style={{fontSize:12,color:"#6f8098",letterSpacing:".01em",lineHeight:1.35}}>Control de Implementaciones y Auditoria</div>
        </div>
