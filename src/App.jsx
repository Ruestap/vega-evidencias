/* ET_FIX_ESTADO_SCOPE_REPORTE_ODT_20260620 */
              ...
              <div style={{...SH,overflowX:"auto",maxWidth:"100%"}}>
                <table style={{width:"100%",borderCollapse:"collapse",fontSize:12,minWidth:1320}}>
                  ...
                  <tbody>
                    ...
                    {odtsReporte.map(o=>{
                      const estadoFila=String(o?.estadoUi||o?.estado||"pendiente").toLowerCase();
                      const estadoFirestore=String(o?.estado||estadoFila||"pendiente").toLowerCase();
                      const p=pillE(estadoFila);
                      const isHL=odtHighlighted===o.id;
                      const vencida=o.fechaEntrega&&todayStr()>o.fechaEntrega&&!isOdtFinalizada({...o,estado:estadoFila});
                      return(
                        <tr key={o.id}
                          ...
                          <td style={{padding:"12px 10px"}}>
                            {canUpdateOdtState(o)
                              ?<select value={estadoFirestore} onChange={async e=>{
                              ...
                              :renderStateChip(estadoFila,true)
                            }
                          </td>
                          <td style={{padding:"12px 10px"}}>
