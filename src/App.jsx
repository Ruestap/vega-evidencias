  ...
  return(
    <div style={{fontFamily:"'DM Sans',system-ui,sans-serif",background:"linear-gradient(135deg,#1a2f4a,#0d1f35)",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
      ...
      <div style={{width:"100%",maxWidth:420,background:"#fff",borderRadius:20,padding:"30px 34px 36px",boxShadow:"0 24px 60px rgba(0,0,0,.3)",textAlign:"center",overflow:"visible"}}>
        ...
        <div style={{fontFamily:"'Syne',sans-serif",fontSize:20,fontWeight:800,lineHeight:1.45,paddingBottom:12,marginBottom:10,overflow:"visible",display:"flex",justifyContent:"center",alignItems:"flex-end",gap:0,whiteSpace:"nowrap"}}>
          <span style={{color:"#1a2f4a"}}>Estrategia</span><span style={{color:"#e74c3c"}}>Trade</span>
        </div>
        <div style={{fontSize:12,color:"#7f93ab",letterSpacing:".01em",lineHeight:1.35,marginTop:6,marginBottom:26,padding:"0 10px"}}>Control de Implementaciones y Auditoria</div>
