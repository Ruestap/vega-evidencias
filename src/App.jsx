  ...
  return (
    <div className="et-app-root" style={{fontFamily:"'DM Sans',system-ui,sans-serif",display:"flex",height:"100vh",overflow:"hidden",background:"#F5F7FB"}}>
      ...
      {modulo===0&&(tab===7||tab===8||tab===9)&&(["admin","coordinador","ejecutor","solicitante","visor","viewer"].includes(role))&&(()=>{
        ...
        const ODT_BASE=[]; // ET: sin mocks locales; ODT solo Firestore + sesión actual
        ...
        // ET_FIX: ODT sin mocks/localStorage; Firestore es la fuente y odtCreated solo cubre la sesión mientras llega snapshot.
        [...ODT_BASE,...(odtCreated||[]),...(odtFirestore||[])].forEach(o=>{ if(o&&o.id) odtsMap.set(String(o.id),o); });
        ...
        const getOdtPhone=(u)=>String(u?.celular||u?.telefono||u?.phone||u?.whatsapp||u?.movil||u?.dcel||"").replace(/\D/g,"");
        ...
        const openWhatsOdt=(o)=>{const tel=normalizePeruPhone(o.dcel||o.celular||o.telefono||o.phone||o.whatsapp||"");const msg=buildOdtWhats(o);const url=tel?"https://wa.me/"+tel+"?text="+encodeURIComponent(msg):"https://wa.me/?text="+encodeURIComponent(msg);const win=window.open(url,"_blank","noopener,noreferrer");if(!win){const a=document.createElement("a");a.href=url;a.target="_blank";a.rel="noopener noreferrer";document.body.appendChild(a);a.click();setTimeout(()=>{try{document.body.removeChild(a);}catch{}},300);}};
