...
{cfgTab===4&&(
  ...
  return (
    <div className="et-app-shell" style={{fontFamily:"'DM Sans',system-ui,sans-serif",display:"flex",height:"100vh",overflow:"hidden",background:"#F5F7FB"}}>
      ...
      <style>{`*{box-sizing:border-box;} .vr-table{overflow-x:auto;-webkit-overflow-scrolling:touch;} .vr-table table{min-width:480px;} button,select,input[type=date]{touch-action:manipulation;min-height:36px;} .vr-pill{white-space:nowrap;flex-shrink:0;} .et-nav-item:hover{background:#1E293B!important;} @media(max-width:760px){.et-app-shell{display:block!important;height:auto!important;min-height:100dvh!important;overflow:visible!important;}.et-sidebar{display:none!important;}.et-main-area{min-height:100dvh!important;overflow:visible!important;}.et-content{overflow:visible!important;}.et-topbar{height:auto!important;min-height:56px!important;padding:8px 10px!important;gap:8px!important;flex-wrap:wrap!important;}.et-topbar input[type=date]{max-width:138px;flex:1 1 130px;}.et-tabs{padding:0 8px!important;overflow-x:auto!important;-webkit-overflow-scrolling:touch;}.et-tabs button{flex:0 0 auto!important;padding:10px 12px!important;}.audit-home{padding:12px 10px 80px!important;}.audit-kpi-grid{grid-template-columns:1fr!important;}.audit-store-select{padding-bottom:96px!important;}}`}</style>
      ...
      {/* ══ MAIN AREA ══ */}
      <div className="et-main-area" style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        {/* ── CONTENIDO ── */}
        <div className="et-content" style={{flex:1,overflowY:"auto",background:"#F5F7FB"}}>
      ...
      {tab===4&&isAuditor&&(
        ...
        {auditPaso===0&&(()=>{
          ...
          return(
          <div className="audit-home" style={{padding:"14px 16px",paddingBottom:80}}>
            <div style={{fontWeight:800,fontSize:15,color:"#1a2f4a",marginBottom:14}}>Panel de Avances</div>
            <div className="audit-kpi-grid" style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:8,marginBottom:14}}>
              {[
...
function SeleccionTienda({tiendas,onCheckIn,auditExclusiones,onSolicitarExclusion,isAdmin,onGestionarExclusion}){
  ...
  return(
    <div className="audit-store-select" style={{paddingBottom:80}}>
